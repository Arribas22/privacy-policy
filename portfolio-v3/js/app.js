...
const translations = {
  es: {
    ...
    'certs.label': 'Formacion certificada',
    'certs.title': 'Certificados',
    'certs.desc':  '7 certificaciones Claude completadas para especializacion en IA aplicada al desarrollo profesional.',
    'cert1.meta':  'Emitido: 11 de mayo de 2026 · ID fgc3ws7upbph',
    'cert2.meta':  'Emitido: 11 de mayo de 2026',
    'cert3.title': 'Introduction to Claude Cowork',
    'cert3.meta':  'Emitido: 13 de mayo de 2026',
    'cert4.title': 'Claude Code in Action',
    'cert4.meta':  'Emitido: 13 de mayo de 2026 · ID 524wbaecyt9y',
    'cert5.title': 'AI Fluency: Framework & Foundations',
    'cert5.meta':  'Emitido: 15 de mayo de 2026',
    'cert6.title': 'Introduction to Model Context Protocol',
    'cert6.meta':  'Emitido: 20 de mayo de 2026 · ID dgkrfy6e6e78',
    'cert7.title': 'Model Context Protocol: Advanced Topics',
    'cert7.meta':  'Emitido: 20 de mayo de 2026 · ID ucgkw4kpak8i',
    'cert.badge':  'Completado',
    'cert.link':   'Ver certificado',
    'cert.private': 'Verificacion privada',
  ...
  en: {
    ...
    'certs.label': 'Certified training',
    'certs.title': 'Certificates',
    'certs.desc':  '7 completed Claude certifications focused on AI applied to professional software development.',
    'cert1.meta':  'Issued: May 11, 2026 · ID fgc3ws7upbph',
    'cert2.meta':  'Issued: May 11, 2026',
    'cert3.title': 'Introduction to Claude Cowork',
    'cert3.meta':  'Issued: May 13, 2026',
    'cert4.title': 'Claude Code in Action',
    'cert4.meta':  'Issued: May 13, 2026 · ID 524wbaecyt9y',
    'cert5.title': 'AI Fluency: Framework & Foundations',
    'cert5.meta':  'Issued: May 15, 2026',
    'cert6.title': 'Introduction to Model Context Protocol',
    'cert6.meta':  'Issued: May 20, 2026 · ID dgkrfy6e6e78',
    'cert7.title': 'Model Context Protocol: Advanced Topics',
    'cert7.meta':  'Issued: May 20, 2026 · ID ucgkw4kpak8i',
    'cert.badge':  'Completed',
    'cert.link':   'View certificate',
    'cert.private': 'Private verification',
